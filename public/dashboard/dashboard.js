...
function onCreateSubmit(event) {
  ...
  HTTP.createTestimony({
    ...
    onSuccess: function() {
      $(".notification").html(` Request was submitted successfully`);
      pastSubmittedTestimonies();
    },
    onError: err => {
      $(".notification").html(
...
function onSubmitEditTestimony(event) {
  ...
  HTTP.updateTestimony({
    ...
    onSuccess: function() {
      $(".notification").html(` Request was edited successfully`);
      pastSubmittedTestimonies();
    },
    onError: err => {
      $(".notification").html(`ERROR: Request was not updated successfully`);
    }
  });
